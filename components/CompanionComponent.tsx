...
const CompanionComponent = ({companionId, subject, userName,
                                userImage, topic, name, style, voice}: CompanionComponentProps) => {
    ...
    const toggleMicrophone = () => {
        if (callStatus === CallStatus.ACTIVE) {
            ...
            console.warn('No active call to toggle microphone.');
        }
    }
