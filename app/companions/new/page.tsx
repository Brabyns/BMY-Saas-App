        ...
        <main className="min-lg:w-1/3 min-md:w-2/3 justify-center items-center">
            {canCreateCompanion ? ( <article className="w-full gap-4 flex flex-col">
                ...
                <article className="companion-limit">
                    ...
                    <p>You’ve reached your companion limit. Upgrade to create
                        more companions and premium features.</p>
                    <Link href="/subscription" className="btn-primary w-full justify-center m-5">
                        Upgrade My Plan
                    </Link>
                </article>
            )}
