...
export const Journey = () => {
  return (
      <svg width="200" height="200" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path    d="M32,5.9C17.6,5.9,5.9,17.6,5.9,32S17.6,58.1,32,58.1S58.1,46.4,58.1,32S46.4,5.9,32,5.9z M33.1,55.8v-3.1
c0-0.6-0.5-1.1-1.1-1.1s-1.1,0.5-1.1,1.1v3.1C18.6,55.3,8.7,45.4,8.2,33.1h3.1c0.6,0,1.1-0.5,1.1-1.1s-0.5-1.1-1.1-1.1H8.2
C8.7,18.6,18.6,8.7,30.9,8.2v3.1c0,0.6,0.5,1.1,1.1,1.1s1.1-0.5,1.1-1.1V8.2c12.3,0.6,22.2,10.5,22.7,22.7h-3.1
 c-0.6,0-1.1,0.5-1.1,1.1s0.5,1.1,1.1,1.1h3.1C55.3,45.4,45.4,55.3,33.1,55.8z" stroke="#4b5563" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
        <defs>
